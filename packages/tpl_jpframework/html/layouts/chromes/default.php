...
if ($module->content) : ?>
	<<?php echo $moduleTag; ?> class="<?php echo $modulePos; ?> card mb-3 <?php echo htmlspecialchars($params->get('moduleclass_sfx')); ?>">
		<?php if ($module->showtitle && $headerClass !== 'card-title') : ?>
			<<?php echo $headerTag; ?> class="card-header<?php echo $headerClass; ?> bg-primary text-light"><?php echo $module->title; ?></<?php echo $headerTag; ?>>
		<?php endif; ?>
		<div class="card-body">
			<?php if ($module->showtitle && $headerClass === 'card-title') : ?>
