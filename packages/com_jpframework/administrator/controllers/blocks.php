...
class JpframeworkControllerBlocks extends JControllerAdmin
{
	...
	*/
	public function addBlock()
	{
		...
		$entry = $this->getModel('blocks')->addEntry($block);
		...
		{
			$this->setMessage(JText::_('COM_JPFRAMEWORK_NEW_BLOCK_ADDED_ERROR'), 'error');
		}

		$this->setRedirect('index.php?option=com_jpframework&view=blocks');
	}
	...
	public function duplicate()
	{
		...
		{
			$this->setMessage(JText::plural('COM_JPFRAMEWORK_N_BLOCKS_DUPLICATED_ERROR', 'error'));
		}
	...
	*/
	public function removeBlock()
	{
		...
		{
			$this->setMessage(JText::_('COM_JPFRAMEWORK_BLOCK_DELETED_ERROR'), 'error');
		}
	...
	*/
	public function lessCompiler()
	{
		...
		$this->setRedirect('index.php?option=com_jpframework&view=blocks', JText::_('JP_FRAMEWORK_LESS_COMPILED'));
	}
