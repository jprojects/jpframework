...
<form action="<?php echo JRoute::_('index.php?option=com_jpframework&view=blocks'); ?>" method="post" name="adminForm" id="adminForm">
...
<?php endif;?>
		...
		<table class="table table-striped" id="blocksList">
			<thead>
                ...
                <th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_JPFRAMEWORK_BLOCKS_TITLE', 'a.title', $listDirn, $listOrder); ?>
				</th>    
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_JPFRAMEWORK_BLOCKS_TYPE', 'a.type', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_JPFRAMEWORK_BLOCKS_POSITION', 'a.position', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_JPFRAMEWORK_BLOCKS_LANGUAGE', 'a.position', $listDirn, $listOrder); ?>
				</th>
			...
			<?php foreach ($this->items as $i => $item) :
                ...
                <?php endif; ?>
                <td>
                	<a href="<?php echo JRoute::_('index.php?option=com_jpframework&task=block.edit&id='.(int) $item->id); ?>">
					<?php echo $item->title; ?>
					</a>
				</td>   
				<td>
