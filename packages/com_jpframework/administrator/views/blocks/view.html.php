    ...
    protected function addToolbar() {
        ...
        if (isset($this->items[0]->state)) {
            if ($canDo->get('core.delete')) {
                JToolBarHelper::deleteList('', 'blocks.delete', 'COM_JPFRAMEWORK_DELETE_BLOCK');
                JToolBarHelper::divider();
        ...
        foreach(JpframeworkHelper::getBlocks() as $block) {
		    ...
		    JHtmlSidebar::addEntry(
				...
				'index.php?option=com_jpframework&task=blocks.addBlock&block='.$block.'&'.JSession::getFormToken().'=1',
				false
